...
extension FilterCollectionViewController {
    ...
    private func adjustFilter(name filterName: String,
        ...
        self.imageOperationQueue.addOperation {
            guard let inputImage: UIImage = self.thumbnailImage else {
                return
            }
            
            guard let filter: CIFilter = CIFilter(name: filterName) else {
                return
            }
            
            guard let ciImage: CIImage = CIImage(image: inputImage) else {
                return
            }
            ...
            OperationQueue.main.addOperation {
                ...
                guard let cell: FilterCollectionViewCell = cellAtIndex as? FilterCollectionViewCell else {
                    return
                }
...
extension FilterCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        guard let cell: FilterCollectionViewCell = cell as? FilterCollectionViewCell else {
            return
        }
